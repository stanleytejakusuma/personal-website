...
export const SITE_DESC =
  'Stanley Tejakusuma. Data engineer across blockchain and analytics: pipelines, models, and trading systems.';

export const TAGLINE = 'data · pipelines · models · execution';
