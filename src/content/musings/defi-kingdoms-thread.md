---
title: DeFi Kingdoms (Thread)
description: Max 280 char DeFi Kingdoms is an 8-bit GameFi built on Harmony blockchain
  that is integrated with a DEX, a liquidity pool, and a NFT marketplace with the
  native token $JEWEL....
date: '2022-01-08'
venue: wagmi
tags:
...
The smart contract is audited by Solidity Finance ([<u>https://solidity.finance/audits/DefiKingdoms/</u>](https://solidity.finance/audits/DefiKingdoms/)) with passing all of the vulnerability coverage.
