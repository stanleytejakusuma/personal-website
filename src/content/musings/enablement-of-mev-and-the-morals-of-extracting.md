...
<img src="/musings/enablement-of-mev-and-the-morals-of-extracting/image-04.webp" style="width:6.5in;height:2.41667in" />
  ...
  - **Locating MEV**: Understanding how a searcher discovers transactions.
    ...
    - Methodology to find transactions:
      ...
      - Proposer Feed: Proposer publishes pending or recently ordered tx.\
        \
        <img src="/musings/enablement-of-mev-and-the-morals-of-extracting/image-03.webp" style="width:6.5in;height:2.94444in" />
...
- \<aside\> 💡 To conclude, **any information about transactions can enable MEV.** \*\*Most discourse about MEV focuses on the ability for searchers to locate and interfere with the execution of pending transactions. However, even if the Proposer is completely trusted not to allow searchers to locate pending transactions, there's still the potential for searchers to utilize any information made available by the Proposer.\
  ...
  - <img src="/musings/enablement-of-mev-and-the-morals-of-extracting/image-02.webp" style="width:6.5in;height:3.09722in" />

  - **Exploitation Strategies**: Investigating various strategies employed to exploit MEV opportunities.

- <img src="/musings/enablement-of-mev-and-the-morals-of-extracting/image-01.webp" style="width:6.5in;height:3.65278in" />\
  \
...
- <img src="/musings/enablement-of-mev-and-the-morals-of-extracting/image-05.webp" style="width:6.5in;height:3.25in" />\
...
- Morality of MEV:
  ...
  - <img src="/musings/enablement-of-mev-and-the-morals-of-extracting/image-06.webp" style="width:6.5in;height:0.875in" />
