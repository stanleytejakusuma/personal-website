---
title: Illuvium
description: Introduction In a world of its own, Illuvium started to announce its
...
<img src="/musings/illuvium/image-04.webp" style="width:3.58204in;height:2.0149in" />
...
Here is a [<u>link</u>](https://www.youtube.com/watch?v=5p0iUNTSHsY) to a teaser for the open-world of Illuvium.
...
<img src="/musings/illuvium/image-03.webp" style="width:3.43995in;height:1.3837in" />
...
<img src="/musings/illuvium/image-01.webp" style="width:7.09662in;height:2.22382in" />
...
All of the revenue stream generated in Illuvium either from in-game purchases or IlluviDEX exchange fees would be channeled into Illuvium Vault. Specifically, in-game purchases include shard curing (used to catch Illuvials), imbues, obelisk travel (fast travel), wagering battle fees, enhancement, revival, and cosmetics. Exchange and wagering fees generated from every sale takes up an initial rate of 5% through the IlluviDEX. Additionally, Immutable X takes a small capped fee in exchange for wavering the gas fees. [<u>link</u>](https://medium.com/illuvium/9-tokenomics-launchpad-and-reward-details-5894c3b356be)

Governance

Illuvium takes an interesting approach when it comes to governance; contrary to the common method of governance – holding the governance token would grant the holders voting power in proposals. Illuvium’s governance adheres to a council voted by holders of ILV, similar to NEO smart economy and DOT. The role of council is mainly as community reps who are able to convey community’s hopes without directly influencing the voting weight of proposals.

Voting for the proposal, however, still follows the same conventional approach of governance. There are two different types of proposal in Illuvium:

1.  Illuvium Configuration Change Proposal – able to modify systems config variables
...
2.  Illuvium Improvement Proposal
...
<img src="/musings/illuvium/image-02.webp" style="width:2.89265in;height:1.93958in" />

Pokemon Go & Hearthstone Statistics

It is important to note that Pokemon has been a long standing brand ever since 1996 whilst Hearthstone is the first unique strategy card game. Illuvium stands on the cross-section between these two games. Under the assumption that Illuvium could attract 25% of the average number of players between the two games (~10 million players), Illuvium would undoubtedly generate a high revenue. Seeing that both of these games have in-game purchases around the range of $1 to $100; If Illuvium prices the purchases around these ranges, then the total number of sales would be between $10 million to $1 billion, given that all players will inevitably purchase at least $1 from the game. Since most of Illuvium’s source of revenue comes from the IlluviDEX, 5% to be precise, this would result in Illuvium to generate revenue around the range of $500k - $50 million. Though, certainly Illuvium still has a long way to go since Pokemon and Hearthstone are both giants in the gaming industry.

Looking at Illuvium’s direct competitors, it’s more than reasonable to say the least that the game has the upperhand amongst other similar crypto gaming projects. Take [<u>Untamed Island</u>](https://untamedisles.com/game-overview/) and [<u>NFT Champions</u>](https://firebasestorage.googleapis.com/v0/b/nft-champions.appspot.com/o/NFT%20Champions%20Whitepaper%20V5.pdf?alt=media&token=fa0a5512-1acc-4f0a-88b2-ae091315da9b) as an example. Both of these games are a worthwhile venture to pursue, however they do not have the technology level that Illuvium has. Illuvium is built on Unreal Engine 4 – the most powerful 3D game creation tool with real-time technology. Furthermore, its backend is supported and integrated with Chainlink and Immutable X.

Team

<img src="/musings/illuvium/image-05.webp" style="width:3.34792in;height:2.51094in" />
...
1.  Kieran Warwick (Co-Founder): Serial entrepreneur who was exposed to Bitcoin and Ethereum early on. Helped The Burger COllective amass 100k unique reviews, 20k monthly web app users, and established partnership with DoorDash. Worked alongside his brother at Synthetix.

2.  Aaron Warwick (Co-Founder \| Game Designer)

3.  Danny Wilson (Partnerships)

4.  Nate Wells (Game Producer)

5.  Basil Gorin (CTO)

6.  John Avery (Lead Server Engineer)

7.  Rogier van de Beek (Lead Concept Artist)

8.  Aleksandr Kirilenko (Lead Modeler)

9.  Dimitriy Ten (Lead Environmental Artist)

10. Marcel Reyes (Marketing Manager)

In addition, Twitch/Playstation’s Scott McCarthy and Riot Games’ Veronica Foo [<u>join</u>](https://medium.com/illuvium/twitch-playstations-scott-mccarthy-and-riot-games-veronica-foo-join-illuvium-as-key-marketing-3e83aec5c2a9) Illuvium as key marketing executives. Both of the new joiners will focus on Illuvium’s branding in both the cryptospace and mainstream gaming industry.

Partners

Illuvium took an interesting decision when partnering with the Blockchain Gaming Association ([<u>link</u>](https://medium.com/illuvium/15-joining-the-blockchain-game-alliance-to-promote-nfts-and-play-to-earn-in-gaming-8aa554049d86)). Not only is the BGA a well-known association for web3 gaming that promotes decentralization, but also the partnership indirectly exposes Illuvium to numerous renowned BGA sponsors (i.e. Ubisoft, AMD, Animoca Brands, Gameloft, Atari, etc).
...
2.  Private Investors
    ...
    1.  Richard Ma - CEO Quantstamp

    2.  Kain Warwick - Synthetix founder

    3.  Stani Kulechov - $AAVE founder

    4.  Anton Bukov - $1INCH DEX founder

    5.  Tyler Ward - Barnbridge founder

    6.  Santiago Santos - Partner ParaFi

    7.  Dansih Chowdry - CEO Bitcoin.com

    8.  Jason Choi - Spartan Capital/Blockcrunch

    9.  Sebastian Borget - $SAND founder

    10. Kevin Lu - Band Protocol developer

Additional Review

Early announcement focuses on gameplay features (teasing), but recent announcement leans more towards security and building a strong foundation be it for the team or the platform itself. Going in the right direction since users wouldn’t want to be hacked when the project has fully launched. TL;DR resource are focused on security and building a strong foundation
